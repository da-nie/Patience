...
//конструктор
//----------------------------------------------------------------------------------------------------
CVideo::CVideo(uint32_t width,uint32_t height)
{
 ScreenWidth=width;
 ScreenHeight=height;
 WindowHeight=height;
...
//----------------------------------------------------------------------------------------------------
void CVideo::GetScreenSize(uint32_t &width,uint32_t &height) const
{
 width=ScreenWidth;
 height=ScreenHeight;
}
...
//----------------------------------------------------------------------------------------------------
void CVideo::GetWindowSize(uint32_t &width,uint32_t &height) const
{
 width=ScreenWidth;
 height=WindowHeight;
}
...
//получить центр окна
//----------------------------------------------------------------------------------------------------
void CVideo::GetWindownCenter(uint32_t &xcenter,uint32_t &ycenter) const
{
...
//----------------------------------------------------------------------------------------------------
void CVideo::GetVideoPointer(uint32_t* &vptr,uint32_t &linesize) const
{
 linesize=LineSize;
 vptr=VideoBuffer; 
}
...
//----------------------------------------------------------------------------------------------------
void CVideo::SetVideoPointer(uint32_t* vptr,uint32_t linesize)
{
 VideoBuffer=vptr;
 LineSize=linesize;
}
...
//----------------------------------------------------------------------------------------------------
void CVideo::PutSymbol(uint32_t x,uint32_t y,char symbol,uint32_t color)
{ 
 ...
 for(uint32_t ys=0;ys<FONT_HEIGHT;ys++)
 {
  ...
  {   
   ...
   uint32_t *v_ptr=VideoBuffer+x+xs+(y+ys)*LineSize;
...
//----------------------------------------------------------------------------------------------------
void CVideo::PutString(uint32_t x,uint32_t y,const char *string,uint32_t color)
{
...
//вывод точки
//----------------------------------------------------------------------------------------------------
void CVideo::DrawPoint(uint32_t x,uint32_t y,uint32_t color)
{
 if (x<0 || x>=ScreenWidth) return;
 if (y<0 || y>=ScreenHeight) return;
 uint32_t *v_ptr=VideoBuffer+x+y*LineSize;
 *v_ptr=color;
}